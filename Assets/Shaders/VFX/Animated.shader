Shader "PBR/FX/Animated"
{
	Properties
	{
		...
		[Toggle] PBR_USE_SECOND_DISTORT_UV("Use Second UV", Float) = 0
		...
		[BitmaskEnum(UnityEngine.Rendering.ColorWriteMask, All)] HARDWARE_ColorWrite ("Color write mask", Float) = 14
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature PBR_USE_SECOND_DISTORT_UV_ON
