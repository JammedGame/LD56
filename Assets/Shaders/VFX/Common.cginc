...
#define PBR_COMMON_CGINC
	...
	struct VInput
	{
		...
		float2 uv : TEXCOORD0;
		#if defined(PBR_LIGHTMAP_ON) || defined(PBR_USE_SECOND_UV_ON) || (defined(PBR_USE_SECOND_DISTORT_UV_ON) && defined(PBR_USE_DISTORT_MAP_ON))
			half2 uv2 : TEXCOORD1;
		#endif
...
#define TRANSFORM_TEX(tex,name) (tex.xy * name##_ST.xy + name##_ST.zw)
	...
	FInput vertPBR(VInput v)
	{
		...
		#if defined(PBR_USE_SECOND_DISTORT_UV_ON) && defined(PBR_USE_DISTORT_MAP_ON)
		o.uv2 = v.uv2;
		#endif
